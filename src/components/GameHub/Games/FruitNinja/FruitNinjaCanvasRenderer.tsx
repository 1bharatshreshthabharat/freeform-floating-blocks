...
export const FruitNinjaCanvasRenderer: React.FC<CanvasRendererProps> = ({
  canvasRef,
  gameState,
  fruits,
  particles,
  ...
  // Expose the draw function via a custom hook
  React.useImperativeHandle(canvasRef, () => ({
    draw
  }));

  return null; // This component doesn't render anything, it just provides the draw function
};
